...
void simpleIntegralsLegendre() {
	...
	auto integral_1 = GQLegendre<NPoint::_10, double>{ firstIntegrand };
	auto integral_2 = GQLegendre<NPoint::_10, double>{ secondIntegrand };

	std::cout << "10-point Gauss-Legendre integral value: " << integral_1() << "\n";
	std::cout << "10-point Gauss-Legendre integral value: " << integral_2() << "\n";
	std::cout << "===========================================\n";
}



void fresnelIntegralsLegendre() {
	...
	auto S = [&](double x){
		...
		auto integral = GQLegendre<NPoint::_20, double>{ Integrand<double, double>{ sinFun,range } };
		return integral();
	};
	...
	auto C = [&](double x) {
		auto range = Range<double>{ 0.0,x };
		auto integral = GQLegendre<NPoint::_20, double>{ Integrand<double, double>{ cosFun,range } };
		return integral();
	};
